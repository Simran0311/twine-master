$(function() {
  ...
  Grnhse.Settings = {
    ...
    scrollOnLoad: true,
    autoLoad: true,
    boardURI: "https://boards.greenhouse.io/embed/job_board?for=twinelabs",
    applicationURI: "https://boards.greenhouse.io/embed/job_app?for=twinelabs",
    baseURI:
      "https://5e539a81217e84000a7ce8e5--heuristic-jennings-1d6c7e.netlify.com/",
    iFrameWidth: "100%"
  };
  var Grnhse = Grnhse || {};
  Grnhse.Const = {
  ...
  Grnhse.Route = {
    ...
    applicationUrl: function(source, jobId) {
      ...
      console.log(settings.applicationURI, source);
